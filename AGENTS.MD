...
- [ ] Відображення кнопки "Set as Default"/"Unregister" з правильним текстом залежно від статусу
- [ ] Вибір команди мишею
- [ ] Вибір команди клавіатурою (Enter)
- [ ] Навігація стрілками
- [ ] Швидкий вибір 1-9
- [ ] Реєстрація та встановлення як браузер за замовчуванням через кнопку "Set as Default"
- [ ] Перевірка чи застосунок вже є браузером за замовчуванням
- [ ] Видалення реєстрації через кнопку "Unregister"
- [ ] Оновлення тексту кнопки після зміни статусу
- [ ] Відкриття Windows Settings для ручного вибору (на Windows 10+)
